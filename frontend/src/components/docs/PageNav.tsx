    ...
    <nav className="mt-16 grid gap-3 border-t border-line-soft pt-8 sm:grid-cols-2">
      {previous ? (
        <Link href={previous.href} className="doc-card block">
          <Card className="h-full rounded-card bg-surface/40 py-4 transition hover:ring-brand/40">
      ...
      {next && (
        <Link href={next.href} className="doc-card block sm:col-start-2">
          <Card className="h-full rounded-card bg-surface/40 py-4 text-right transition hover:ring-brand/40">
            <div className="px-(--card-spacing)">
